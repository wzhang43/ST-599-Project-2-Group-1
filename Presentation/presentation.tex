...
\begin{center}
  \scalebox{0.57}{\includegraphics{../Maps/NOAA-map.png}}
\end{center}
\end{frame}
...
\begin{center}
  \scalebox{0.45}{\includegraphics{../Images/PopnSummary_USE.pdf}}
\end{center}
\end{frame}
...
\begin{center}
  \scalebox{0.52}{\includegraphics{../Images/popn_prop.png}}
\end{center}
\end{frame}
...
\begin{center}
  \scalebox{0.45}{\includegraphics{../Images/popn_prop_northrockies.png}}
\end{center}
\end{frame}
...
\frametitle{Proportion of Weather Delayed Flights, by Month}
\begin{center}
  \scalebox{0.45}{\includegraphics{../Images/SampSumm_USE.pdf}}
\end{center}
\end{frame}
...
\frametitle{All Regions}
\begin{center}
  \scalebox{0.52}{\includegraphics{../Images/samp_prop.png}}
\end{center}
\end{frame}
...
\begin{center}
  \scalebox{0.52}{\includegraphics{../Images/samp_prop_south.png}}
\end{center}
\end{frame}
...
\begin{center}
  \scalebox{0.34}{\includegraphics{../Images/ComparePopnandSamp.png}}
\end{center}
\end{frame}
